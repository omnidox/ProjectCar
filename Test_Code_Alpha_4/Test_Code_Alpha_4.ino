// made an algorithm if left sensor 2 > 40, turn left. If right sensor 5 > 40, turn right.
...
//added two more else if statements for extreme turns. 
    else if (distance2 > 40)
    {
        setVehicle(0, NORMAL);
    }

    else if (distance5 > 40)
    {
        setVehicle(180, NORMAL);
    }
