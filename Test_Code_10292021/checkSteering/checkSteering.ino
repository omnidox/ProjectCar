...
//******Please input the code of your approaches/algorithms in the below area*****************//
  ...
  if(distance3 <= 20) //Demo code for safety distance to stop the vehicle
  {  
    setVehicle(45,90); //Call the setVehicle function to set the vehicle steering and velocity(speed) values 
  }
  
  if(distance3 > 20) //Greater than safety distance, run the vehicle
  {  
    setVehicle(135,100); //Call the setVehicle function to set the vehicle steering and velocity(speed) values 
  }
