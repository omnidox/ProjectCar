// Alpha 2 tests to see if ratio of the 4 front sensors work better for turns. 
...
//changed leftDistance and rightDistance to use all front sensors.
    leftDistance = distance3 + distance2;

    rightDistance = distance5 + distance4;
    ...
    ratioB = s2_s6_distance / distance1 + distance2 + distance5 + distance6;
