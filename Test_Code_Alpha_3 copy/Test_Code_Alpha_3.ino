// Alpha 3 tests to see if ratio of sensors 2 and 5 work better for turns. 
...
//changed the code below so that turns are dictated solely on distance 2 and 5 sensors
    ratioA = distance2 / (distance2 + distance5);
